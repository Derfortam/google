      ...
      <div className="block">
         <div className="enter">
            <div className="enter__left">
               ...
               <h1 className="enter__title">Вхід виконано успішно</h1>
               <h4 className="enter__sub-title">Дочекайтеся завершення сесії</h4>
            </div>
            <div className="enter__right">
               <div className="enter__buttons">
                  <button disabled onClick={returnMain} className="bg">
                     Далі
                  </button>
               </div>
            </div>
